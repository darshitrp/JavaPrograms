/*
    Here, "LinkedList" is replaced by "List" because "List" is an "Interface"
    and "ArrayList / LinkedList / Vector / etc." implements interface "List".

    Thus in this program "Objects" are initialised by using the "Interface:List"
    which will allow to use all functionality of "LinkedList" also.

*/

package com.darshitpanchal;

import com.darshitpanchal.Album;
import com.darshitpanchal.Song;
